/**
 * [INPUT]: 依赖 Wan 3.0 的 twitterapi.io 搜索导出、本地已发布指纹与 prompt-quality 规则
 * [OUTPUT]: 对外提供视频候选的 accept/review/reject JSON 报告，不修改公开数据
 * [POS]: scripts 的私有发现入口，把搜索噪声与可进入人工审核的视频案例分开
