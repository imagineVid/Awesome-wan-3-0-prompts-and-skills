...
> Wan 3.0 Video를 위한 출처 검증형 샷 브리프, 모션 패턴, 시청각 워크플로 라이브러리입니다.
# Awesome Wan 3.0 Video 프롬프트 및 스킬
...
**[ImagineVid에서 Wan 3.0 워크플로 열기](https://imaginevid.io/ko/text-to-video)**
...
- [**카메라 경로와 샷 페이싱**](#workflow-camera-direction-shot-design) - 프레이밍, 카메라 경로, 블로킹, 페이싱, 공개 순서, 전환을 중심으로 구성한 샷 브리프입니다.
- [**네이티브 오디오 및 퍼포먼스**](#workflow-dialogue-performance-native-audio) - 대사, 연기, 분위기음, 음악 또는 동기화된 사운드가 장면을 이끄는 퍼포먼스 중심 프롬프트입니다.
- [**상업적 모션 및 프레젠테이션**](#workflow-product-motion-commercial-spots) - 제품, 오퍼, 의상, 요리, 기기 또는 브랜드 순간을 움직임의 중심에 두는 광고 클립입니다.
- [**레퍼런스 기반 연속성**](#workflow-image-to-video-subject-continuity) - 정지 이미지를 애니메이션화하면서 인물의 정체성, 구도, 제품 형태 또는 스토리보드 레이아웃을 보존하는 이미지 기반 워크플로입니다.
- [**스타일라이즈드 액션 및 효과**](#workflow-stylized-motion-visual-effects) - 변형, 시뮬레이션, 초현실적 물리, 그래픽 모션 또는 독특한 미디어 처리로 구동되는 효과 및 애니메이션 패턴입니다.
- [**비교, 리스타일 및 장면 제어**](#workflow-video-editing-restyling-scene-control) - 연속성을 보호하면서 기존 영상의 스타일을 바꾸고 확장, 추가, 제거, 교체하거나 장면의 방향을 바꾸는 워크플로입니다.

---

## 목차

- [Wan 3.0 Video로 만들기](#wan-30-video로-만들기)
- [Wan 3.0 Video란?](#wan-30-video란)
- [컬렉션 상태](#컬렉션-상태)
- [추천 비디오 프롬프트](#community-featured-prompts)
- [커뮤니티 비디오 프롬프트](#community-prompt-cases)
...
**Wan 3.0 Video**를 출처가 연결된 공개 데모와 커뮤니티 워크플로를 통해 정리합니다. 이 컬렉션은 관찰 가능한 기능 증거와 편집자가 재구성한 내용을 구분합니다. 각 사례에는 제작자, 원본 게시물, 재생 가능한 결과, 모델 표기를 남기며, 재구성한 프롬프트는 원문인 것처럼 제시하지 않고 명확히 표시합니다. 이용 가능 여부와 기능은 바뀔 수 있으므로 제작 전에 현재 접근 조건을 확인하세요.
...
- **기존 영상을 편집** - 클립의 스타일을 바꾸고, 장면 조건을 변경하거나 보이는 요소를 추가, 제거, 교체하세요
- **연속성을 명시적으로 보호** - 변형되어서는 안 되는 얼굴, 제품의 형태, 레이아웃, 의상 또는 배경을 밝혀 두세요

**현재 참고 자료:** [Wan 3.0 workflow on ImagineVid](https://imaginevid.io/ko/text-to-video)
...
| 검증된 사례 | **7** |
| 에디터 추천 | **4** |
| 생성 시각 | **2026년 8월 19일 수요일 오후 12시 38분 25초 UTC** |
...
두 선수를 분리하고 교환 동작을 설계하며 비, 물웅덩이, 카메라와 연속성 제약으로 17초 결투를 명확하게 유지하는 액션 브리프입니다.

#### 현지화 프롬프트

```
폐허가 된 원형 석조 경기장에서 두 성인 여성 선수가 싸우는 17초, 16:9 시네마틱 3D 리얼리즘 영상을 만드세요. 얼굴, 체형, 의상, 위치를 끝까지 일관되게 유지하세요. 주먹, 블록, 패리, 슬립, 풋워크만 사용하세요. 낮은 와이드 숏으로 시작해 교환 중에는 측면 트래킹으로 전환하고, 짧은 슬로모션 회피를 한 번 넣은 뒤 깔끔한 어퍼컷 후 통제된 하프 오비트로 끝내세요. 가벼운 비, 반사되는 물웅덩이, 차가운 달빛, 따뜻한 횃불, 사실적인 땀과 물방울. 대사, 자막, 음악, 무기, 초능력, 해부학적 오류, 중복 인물, 워터마크는 금지합니다.
```
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2084715180269654016/vid/avc1/1280x720/zbe-ld1fHtQVTO0d.mp4?tag=14"><img src="https://pbs.twimg.com/amplify_video_thumb/2084715180269654016/img/asHNjLcS9QnUssHz.jpg" height="420" alt="읽기 쉬운 빗속 경기장 복싱 연출 - Motion preview"></a>

*미리보기를 클릭하여 동영상을 여세요* · **[▶ 동영상 보기 →](https://video.twimg.com/amplify_video/2084715180269654016/vid/avc1/1280x720/zbe-ld1fHtQVTO0d.mp4?tag=14)**
</div>

#### 근거

- **제작자:** [Oprèlia AI](https://x.com/OpreliaAI)
- **정식 출처:** [정식 출처](https://x.com/OpreliaAI/status/2084771796910211529)
- **게시일:** 2026년 8월 4일
- **프롬프트 언어:** en

**[이 연출로 만들기 · ImagineVid](https://imaginevid.io/ko/text-to-video)**

---

<a id="prompt-2"></a>

### #2: 화면 방향을 고정한 7개 샷 창싸움
...
화면 지리, 액션 벡터, 색으로 구분한 에너지, 히트 스톱, 컷 사이의 연속성을 고정하는 7샷 셀 애니메이션 소스 프롬프트입니다.

#### 현지화 프롬프트

```
손으로 그린 2D 셀 애니메이션으로 15초, 16:9, 7샷 전투를 만드세요. 작은 창술가는 화면 왼쪽, 거대한 격투가는 오른쪽에서 시작하며 카메라 축을 전체 영상에서 유지하세요. 창술가의 에너지는 시안, 격투가의 에너지는 타오르는 주황색입니다. 예비 동작, 던져진 석판, 잔해를 뛰어넘는 동작, 공중 파편 계단, 짧은 슬로모션 백핸드, 눈 클로즈업, 반 박자 무음과 히트 스톱이 있는 마지막 창 찌르기를 구성하세요. 디자인, 얼굴, 상처, 경기장 손상, 무거운 잔해 물리와 정확히 7개의 샷을 보존하세요. 추가 샷, 텍스트, 자막, 워터마크, 융합된 몸은 금지합니다.
```
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2084474303987474432/vid/avc1/1920x1080/xdN7PiMNI73-LFHG.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2084474303987474432/img/2GZ8LBxzIzHzoroJ.jpg" height="420" alt="화면 방향을 고정한 7개 샷 창싸움 - Motion preview"></a>

*미리보기를 클릭하여 동영상을 여세요* · **[▶ 동영상 보기 →](https://video.twimg.com/amplify_video/2084474303987474432/vid/avc1/1920x1080/xdN7PiMNI73-LFHG.mp4?tag=29)**
</div>

#### 근거

- **제작자:** [Dani Oros](https://x.com/Dani__oros)
- **정식 출처:** [정식 출처](https://x.com/Dani__oros/status/2084475003223896189)
- **게시일:** 2026년 8월 4일
- **프롬프트 언어:** en
...
### #3: 하나의 시각적 reveal을 가진 TV 드라마 오프닝
...
장소를 세우고 인물을 드러낸 뒤 동기 있는 마지막 비트로 끝내는 Wan 3.0 TV 드라마 오프닝 쇼케이스의 숏 논리를 투명하게 재구성했습니다.

#### 현지화 프롬프트

```
하나의 일관된 시각 세계에서 30초, 16:9 TV 드라마 오프닝을 만드세요. 새벽의 조용한 와이드 숏으로 시작해 비에 젖은 도시 거리를 걷는 인물에게 다가가세요. 이야기의 비트가 바뀔 때만 컷하세요. 반사에 두 번째 인물이 드러나고, 카메라는 주인공을 처마 아래로 따라가며, 느린 푸시인이 손에 든 물건을 알아차리는 순간에 멈춥니다. 의상, 날씨, 건축, 화면 방향을 보존하세요. 절제된 자연색, 발소리, 금속에 떨어지는 비, 먼 교통음, 마지막 reveal의 낮은 음악 상승을 사용하세요. 자막, 로고, 임의의 장면 리셋은 금지합니다.
```
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2084964593970118656/vid/avc1/1920x1080/O-G6eb25Vmm-HSLT.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2084964593970118656/img/Cs_-4_9Ipy0tYbig.jpg" height="420" alt="하나의 시각적 reveal을 가진 TV 드라마 오프닝 - Motion preview"></a>

*미리보기를 클릭하여 동영상을 여세요* · **[▶ 동영상 보기 →](https://video.twimg.com/amplify_video/2084964593970118656/vid/avc1/1920x1080/O-G6eb25Vmm-HSLT.mp4?tag=29)**
</div>

#### 근거

- **제작자:** [WaveSpeed AI](https://x.com/wavespeed_ai)
- **정식 출처:** [정식 출처](https://x.com/wavespeed_ai/status/2084965430687588477)
- **게시일:** 2026년 8월 5일
- **프롬프트 언어:** en
...
PixelDojo의 기능 설명에서 재구성한 재사용 가능한 멀티모달 브리프입니다. 서로 다른 입력에 인물, 장소, 목소리를 지정하고 연속성 규칙을 명시합니다.

#### 현지화 프롬프트

```
세 개의 레퍼런스로 20초, 16:9 시네마틱 장면을 만드세요. 이미지 1은 인물의 정체성, 이미지 2는 장소, 오디오 1은 말하는 목소리를 제공합니다. 인물이 전경에서 참조 장소로 걸어가 카메라를 향해 돌아서고 참조 음성으로 짧고 자연스러운 문장을 말하게 하세요. 얼굴, 머리카락, 옷, 크기, 공간 관계, 목소리 정체성을 끝까지 유지하세요. 느린 측면 이동을 문장 중 부드러운 푸시인으로 바꾸세요. 레퍼런스의 빛과 원근을 맞추고 공간음과 발소리를 추가하세요. 정체성 변화, 추가 인물, 텍스트, 워터마크는 금지합니다.
```
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2083212925255446528/vid/avc1/1280x720/QK8mfQ6SmZT9g0RO.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2083212925255446528/img/XZ674J3NnC6mpSLI.jpg" height="420" alt="분리된 레퍼런스로 인물, 장소, 목소리 조립 - Motion preview"></a>

*미리보기를 클릭하여 동영상을 여세요* · **[▶ 동영상 보기 →](https://video.twimg.com/amplify_video/2083212925255446528/vid/avc1/1280x720/QK8mfQ6SmZT9g0RO.mp4?tag=29)**
</div>

#### 근거

- **제작자:** [PixelDojo](https://x.com/PixelDojoAI)
- **정식 출처:** [정식 출처](https://x.com/PixelDojoAI/status/2083212955072807175)
- **게시일:** 2026년 7월 31일
- **프롬프트 언어:** en
...
- [읽기 쉬운 빗속 경기장 복싱 연출](#prompt-1)
- [하나의 시각적 reveal을 가진 TV 드라마 오프닝](#prompt-3)

<a id="prompt-5"></a>

#### #1: 의도적인 카메라 논리를 가진 세로형 스토리 테스트

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### 이 워크플로가 중요한 이유

한 프롬프트로 만든 세로형 비교에서 재구성한 케이스입니다. 한 인물, 명확한 고조, 장관보다 이야기를 위한 카메라를 중심으로 합니다.

##### 현지화 프롬프트

```
15초, 9:16 세로형 내러티브 테스트를 만드세요. 밤에 깜빡이는 거리 표지판 아래 기다리는 배달원을 미디엄 숏으로 시작하세요. 0~4초는 느린 푸시인과 먼 교통음으로 긴장을 유지합니다. 4~8초에는 두 번째 인물이 배경을 가로지르고, 배달원의 반응이 보일 만큼만 팬하세요. 8~12초에는 빨간 재킷과 젖은 바닥을 유지하며 좁은 통로를 달리는 배달원을 뒤로 트래킹하세요. 12~15초에는 출구와 새벽을 작은 탑숏으로 보여 주세요. 방향, 정체성, 빛과 공간을 고정하고 발소리, 천, 비, 절제된 음악 펄스를 사용하세요. 무작위 컷, 텍스트, 워터마크는 금지합니다.
```
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2085020209925210112/vid/avc1/1920x3238/ltuegtJLzV0abXY_.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2085020209925210112/img/TUR8ROJJ4D0fV7V_.jpg" height="420" alt="의도적인 카메라 논리를 가진 세로형 스토리 테스트 - Motion preview"></a>

*미리보기를 클릭하여 동영상을 여세요* · **[▶ 동영상 보기 →](https://video.twimg.com/amplify_video/2085020209925210112/vid/avc1/1920x3238/ltuegtJLzV0abXY_.mp4?tag=29)**
</div>

##### 근거

- **제작자:** [WaveSpeed AI](https://x.com/wavespeed_ai)
- **정식 출처:** [정식 출처](https://x.com/wavespeed_ai/status/2085025284378538045)
- **게시일:** 2026년 8월 5일
- **프롬프트 언어:** en
...
#### #2: 네이티브 오디오와 시간별 사운드 큐를 쓰는 얼리 액세스 장면
...
텍스트 투 비디오, 이미지 투 비디오, 1080p, 30초, 네이티브 사운드를 언급한 얼리 액세스 게시물에서 재구성했습니다. 오디오를 브리프의 일부로 취급합니다.

##### 현지화 프롬프트

```
빈 해안 도로에 자전거를 탄 사람이 서 있는 첨부 이미지에서 30초, 16:9 시네마틱 이미지 투 비디오 장면을 만드세요. 사람, 자전거 형태, 지평선, 시간을 보존하세요. 카메라가 천천히 옆으로 돌리 이동하는 동안 자연스러운 바람과 먼 파도 소리로 시작합니다. 8초에 출발하고 바퀴, 느슨한 재킷, 도로 물보라가 설득력 있는 무게로 반응하게 하세요. 18초에 낮은 트래킹으로 전환하며 해가 구름 사이로 나옵니다. 타이어, 체인, 바람, 갈매기, 지평선 reveal의 부드러운 음악 상승을 네이티브 오디오로 만드세요. 자막, 로고, 얼굴 변화, 인공 루프는 금지합니다.
```
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2085089914044207104/vid/avc1/1920x1080/YSnIMXNgd_j1-1_q.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2085089914044207104/img/6fdS2Hv6vcDWrnOm.jpg" height="420" alt="네이티브 오디오와 시간별 사운드 큐를 쓰는 얼리 액세스 장면 - Motion preview"></a>

*미리보기를 클릭하여 동영상을 여세요* · **[▶ 동영상 보기 →](https://video.twimg.com/amplify_video/2085089914044207104/vid/avc1/1920x1080/YSnIMXNgd_j1-1_q.mp4?tag=29)**
</div>

##### 근거

- **제작자:** [Enhance AI](https://x.com/enhance_ai)
- **정식 출처:** [정식 출처](https://x.com/enhance_ai/status/2085089954099757225)
- **게시일:** 2026년 8월 5일
- **프롬프트 언어:** en
...
#### #3: 공식 데모 스타일의 환경 reveal과 네이티브 사운드

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### 이 워크플로가 중요한 이유

커뮤니티 게시물이 첨부 영상을 Wan 3.0 공식 데모로 설명한 것을 바탕으로 명확히 재구성했습니다. 확인되지 않은 사양은 사실로 만들지 않습니다.

##### 현지화 프롬프트

```
30초, 16:9 시네마틱 환경 reveal을 만드세요. 블루 아워에 인물이 높은 창을 여는 조용한 실내에서 시작합니다. 느린 핸드헬드 푸시로 동작을 따라가고, 구름과 먼 불빛, 가까운 천에 보이는 바람이 있는 넓은 해안 풍경으로 나가세요. 세계가 열리는 동안 인물과 건축을 일관되게 유지하세요. 실내 공간음에서 바람, 새, 파도, 절제된 오케스트라 상승으로 전환합니다. 마지막 와이드 숏은 몇 초 동안 유지하세요. 공간 연속성, 물리적 빛, 읽기 쉬운 카메라 경로를 우선하세요. 텍스트, 자막, 로고, 임의의 기술 라벨은 금지합니다.
```
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2084741113894584320/vid/avc1/1280x720/VKBqU5of84zaTd6F.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2084741113894584320/img/vqjwcPxwyqxvccJB.jpg" height="420" alt="공식 데모 스타일의 환경 reveal과 네이티브 사운드 - Motion preview"></a>

*미리보기를 클릭하여 동영상을 여세요* · **[▶ 동영상 보기 →](https://video.twimg.com/amplify_video/2084741113894584320/vid/avc1/1280x720/VKBqU5of84zaTd6F.mp4?tag=29)**
</div>

##### 근거

- **제작자:** [Furkan Gozukara](https://x.com/FurkanGozukara)
- **정식 출처:** [정식 출처](https://x.com/FurkanGozukara/status/2084741391012286807)
- **게시일:** 2026년 8월 4일
- **프롬프트 언어:** en
...
- [분리된 레퍼런스로 인물, 장소, 목소리 조립](#prompt-4)
...
- [화면 방향을 고정한 7개 샷 창싸움](#prompt-2)

## 검증된 사례 기여하기

실제 연출 패턴을 가르치는 Wan 3.0 Video 사례를 찾았나요? GitHub Issues를 통해 프롬프트, 재생 가능한 결과, 제작자, 출처, 모델 근거, 입력 모드를 제출하세요.

### GitHub issue

1. [**비디오 프롬프트 제출**](https://github.com/imagineVid/Awesome-wan-3-0-prompts-and-skills/issues/new?template=submit-prompt.yml)
...
**[저장소 성장](https://star-history.com/#imagineVid/Awesome-wan-3-0-prompts-and-skills&Date)**

---

<div align="center">

**[Wan 3.0 Video로 만들기](https://imaginevid.io/ko/text-to-video)** •
...
<sub>버전 관리된 로컬 데이터에서 생성된 시각 2026-08-19T12:38:25.877Z</sub>
