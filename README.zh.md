...
> 面向 Wan 3.0 Video、可核验来源的镜头简报、运动模式与视听工作流库。
# Awesome Wan 3.0 Video 提示词与技能
...
**[在 ImagineVid 中打开 Wan 3.0 工作流](https://imaginevid.io/zh/text-to-video)**
...
- [**镜头路径与镜头节奏**](#workflow-camera-direction-shot-design) - 围绕构图、镜头路径、调度、节奏、揭示和转场构建的镜头简报。
- [**原生音频与表演**](#workflow-dialogue-performance-native-audio) - 以对白、表演、环境声、音乐或同步声音推动场景的表演型提示词。
- [**商业运动与呈现**](#workflow-product-motion-commercial-spots) - 让产品、优惠、服装、菜肴、设备或品牌时刻成为运动中心的商业片段。
- [**参考素材驱动的连续性**](#workflow-image-to-video-subject-continuity) - 以图像为锚点让静帧动起来，同时保留身份、构图、产品结构或分镜布局的工作流。
- [**风格化动作与特效**](#workflow-stylized-motion-visual-effects) - 由变形、模拟、超现实物理、图形运动或独特媒介处理驱动的特效与动画模式。
- [**对比、重塑风格与场景控制**](#workflow-video-editing-restyling-scene-control) - 重塑、延展、添加、移除、替换或改导现有视频场景，同时保护连续性的工作流。

---

## 目录

- [使用 Wan 3.0 Video 创作](#使用-wan-30-video-创作)
- [什么是 Wan 3.0 Video？](#什么是-wan-30-video)
- [集合状态](#集合状态)
- [精选视频提示词](#community-featured-prompts)
- [社区视频提示词](#community-prompt-cases)
- [贡献已核验案例](#贡献已核验案例)
- [许可证](#许可证)
- [创作者鸣谢](#创作者鸣谢)
- [仓库增长](#仓库增长)
...
**Wan 3.0 Video** 页面整理了带有来源链接的公开演示与社区工作流。本集合区分可观察的能力证据和编辑重构：每个案例都保留创作者、原始帖子、可播放结果与模型表述；重构提示词会明确标注，不会伪装成逐字原文。可用性、限制和功能可能变化，投入制作前请确认当前访问条件。
...
- **编辑现有素材** - 重塑片段风格、改变场景条件，或添加、移除、替换可见元素
- **明确保护连续性** - 指出脸部、产品结构、布局、服装或背景中不能漂移的部分

**当前参考：** [Wan 3.0 workflow on ImagineVid](https://imaginevid.io/zh/text-to-video)
...
| 已核验案例 | **7** |
| 编辑精选 | **4** |
| 生成时间 | **2026年8月20日星期四 UTC 01:00:54** |
...
一份 17 秒动作简报：分开两位选手、编排每次攻防，并用雨水、水洼、镜头和连续性约束保持决斗清楚可读。

#### 本地化提示词

```
制作一段 17 秒、16:9、电影感 3D 写实拳击视频：两位成年女性选手在夜晚一座破败的圆形石头竞技场内交手。全程保持面孔、体型、服装和站位一致。只使用拳击、格挡、拍挡、闪避和步法。用低机位大全景开场，交锋时切换到侧向跟拍，加入一次短暂的闪避慢动作，最后在干净的上勾拳后以受控的半环绕结束。轻雨、反光水洼、冷月光、暖火把、真实汗水和水滴。不要对白、字幕、音乐、武器、超能力、解剖错误、重复人物或水印。
```
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2084715180269654016/vid/avc1/1280x720/zbe-ld1fHtQVTO0d.mp4?tag=14"><img src="https://pbs.twimg.com/amplify_video_thumb/2084715180269654016/img/asHNjLcS9QnUssHz.jpg" height="420" alt="雨幕竞技场中的清晰拳击编排 - Motion preview"></a>

*点击预览图打开视频* · **[▶ 观看视频 →](https://video.twimg.com/amplify_video/2084715180269654016/vid/avc1/1280x720/zbe-ld1fHtQVTO0d.mp4?tag=14)**
</div>

#### 证据

- **创作者:** [Oprèlia AI](https://x.com/OpreliaAI)
- **规范来源:** [规范来源](https://x.com/OpreliaAI/status/2084771796910211529)
- **发布时间:** 2026年8月4日
- **提示词语言:** en

**[按此方向创作 · ImagineVid](https://imaginevid.io/zh/text-to-video)**
...
一份七镜头赛璐璐动画源提示词，固定屏幕空间、动作向量、能量配色、冲击定格和剪辑之间的连续性。

#### 本地化提示词

```
制作一段 15 秒、16:9、手绘 2D 赛璐璐动画战斗，共七个镜头。小个子长枪战士从画面左侧开始，巨大的格斗家从右侧开始，整段保持同一摄影机轴线。长枪战士使用青色能量，格斗家使用炽橙色能量。依次表现蓄势、投掷石板、跃过碎石、空中碎片阶梯、短暂慢动作的反手击、眼睛特写，以及带半拍静音和冲击定格的最后一记长枪突刺。保持角色设计、面孔、伤口、竞技场损伤、沉重碎石物理和严格的七镜头数量。不要额外镜头、文字、字幕、水印或身体融合。
```
...
来源: [来源](https://x.com/Dani__oros/status/2084475003223896189)
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2084474303987474432/vid/avc1/1920x1080/xdN7PiMNI73-LFHG.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2084474303987474432/img/2GZ8LBxzIzHzoroJ.jpg" height="420" alt="固定屏幕方向的七镜头长枪决斗 - Motion preview"></a>

*点击预览图打开视频* · **[▶ 观看视频 →](https://video.twimg.com/amplify_video/2084474303987474432/vid/avc1/1920x1080/xdN7PiMNI73-LFHG.mp4?tag=29)**
</div>

#### 证据

- **创作者:** [Dani Oros](https://x.com/Dani__oros)
- **规范来源:** [规范来源](https://x.com/Dani__oros/status/2084475003223896189)
- **发布时间:** 2026年8月4日
- **提示词语言:** en
...
对 Wan 3.0 电视剧式开场展示中的镜头逻辑进行透明重构：先建立地点，再揭示人物，最后落在有动机的节拍上。

#### 本地化提示词

```
制作一段 30 秒、16:9 的电视剧开场，所有内容处于同一个连贯的视觉世界。用黎明时安静的大全景开场，随后推向一个走在雨湿城市街道上的人物。只在叙事节拍变化时剪辑：倒影揭示第二个人物，镜头跟随主角走到遮雨棚下，缓慢推进在他注意到手中物件的瞬间结束。保持服装、天气、建筑和屏幕方向一致。使用克制的自然色、脚步声、雨打金属声、远处交通声，以及揭示时低沉的音乐上扬。不要字幕、标志或任意重置场景。
```
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2084964593970118656/vid/avc1/1920x1080/O-G6eb25Vmm-HSLT.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2084964593970118656/img/Cs_-4_9Ipy0tYbig.jpg" height="420" alt="只有一个视觉揭示的电视剧开场 - Motion preview"></a>

*点击预览图打开视频* · **[▶ 观看视频 →](https://video.twimg.com/amplify_video/2084964593970118656/vid/avc1/1920x1080/O-G6eb25Vmm-HSLT.mp4?tag=29)**
</div>

#### 证据

- **创作者:** [WaveSpeed AI](https://x.com/wavespeed_ai)
- **规范来源:** [规范来源](https://x.com/wavespeed_ai/status/2084965430687588477)
- **发布时间:** 2026年8月5日
- **提示词语言:** en
...
根据 PixelDojo 的能力说明重构的一份可复用多模态简报：用不同输入分别指定身份、地点和声音，并明确连续性规则。

#### 本地化提示词

```
使用三份参考素材制作一段 20 秒、16:9 的电影感场景：图像 1 提供人物身份，图像 2 提供地点，音频 1 提供说话声音。让人物从前景走入参考地点，转向镜头，并用参考声音说出一句短而自然的台词。全程保持面孔、头发、服装、尺度、空间关系和声音身份一致。使用缓慢的横向移动，在台词时转为柔和推进。匹配参考素材的光线和透视，加入环境声和脚步声。不要身份漂移、额外人物、文字或水印。
```
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2083212925255446528/vid/avc1/1280x720/QK8mfQ6SmZT9g0RO.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2083212925255446528/img/XZ674J3NnC6mpSLI.jpg" height="420" alt="从分离的参考素材组装人物、地点和声音 - Motion preview"></a>

*点击预览图打开视频* · **[▶ 观看视频 →](https://video.twimg.com/amplify_video/2083212925255446528/vid/avc1/1280x720/QK8mfQ6SmZT9g0RO.mp4?tag=29)**
</div>

#### 证据

- **创作者:** [PixelDojo](https://x.com/PixelDojoAI)
- **规范来源:** [规范来源](https://x.com/PixelDojoAI/status/2083212955072807175)
- **发布时间:** 2026年7月31日
- **提示词语言:** en
...
- [雨幕竞技场中的清晰拳击编排](#prompt-1)
- [只有一个视觉揭示的电视剧开场](#prompt-3)
...
根据一次同提示词竖屏对比重构：一个人物、清晰升级，以及服务叙事而不是追逐炫技的镜头。

##### 本地化提示词

```
制作一段 15 秒、9:16 的竖屏叙事测试。夜晚从一名快递员在闪烁街牌下等待的中景开始。0 到 4 秒，用缓慢推进和远处交通声保持紧张。4 到 8 秒，第二个人物穿过背景；只做足以显出快递员反应的小幅摇摄。8 到 12 秒，镜头后退跟随快递员穿过狭窄通道，保持红色夹克和湿地面。12 到 15 秒，升到一个紧凑的俯拍，揭示出口和黎明。保持方向、身份、光线和空间地理一致，使用脚步、布料、雨声和克制的音乐脉冲。不要随机剪切、文字或水印。
```
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2085020209925210112/vid/avc1/1920x3238/ltuegtJLzV0abXY_.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2085020209925210112/img/TUR8ROJJ4D0fV7V_.jpg" height="420" alt="用明确镜头逻辑完成竖屏故事测试 - Motion preview"></a>

*点击预览图打开视频* · **[▶ 观看视频 →](https://video.twimg.com/amplify_video/2085020209925210112/vid/avc1/1920x3238/ltuegtJLzV0abXY_.mp4?tag=29)**
</div>

##### 证据

- **创作者:** [WaveSpeed AI](https://x.com/wavespeed_ai)
- **规范来源:** [规范来源](https://x.com/wavespeed_ai/status/2085025284378538045)
- **发布时间:** 2026年8月5日
- **提示词语言:** en
...
根据一条提到文生视频、图生视频、1080p、30 秒和原生声音的早期体验帖重构，并把音频视为简报的一部分。

##### 本地化提示词

```
从一张空旷海岸公路上停着自行车的参考静帧制作一段 30 秒、16:9 的电影感图生视频。保持人物、自行车结构、地平线和时间。镜头缓慢横向移动时，用自然风声和远处海浪开场。第 8 秒人物开始前进；车轮、松动的夹克和路面水花要以可信的重量作出反应。第 18 秒切到低机位跟拍，阳光穿过云层。原生生成轮胎、链条、风、海鸥以及地平线揭示时柔和的音乐抬升。不要字幕、标志、面孔漂移或人工循环。
```
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2085089914044207104/vid/avc1/1920x1080/YSnIMXNgd_j1-1_q.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2085089914044207104/img/6fdS2Hv6vcDWrnOm.jpg" height="420" alt="带原生音频和时间提示的早期体验场景 - Motion preview"></a>

*点击预览图打开视频* · **[▶ 观看视频 →](https://video.twimg.com/amplify_video/2085089914044207104/vid/avc1/1920x1080/YSnIMXNgd_j1-1_q.mp4?tag=29)**
</div>

##### 证据

- **创作者:** [Enhance AI](https://x.com/enhance_ai)
- **规范来源:** [规范来源](https://x.com/enhance_ai/status/2085089954099757225)
- **发布时间:** 2026年8月5日
- **提示词语言:** en
...
根据社区帖子将视频标注为 Wan 3.0 官方演示这一证据明确重构，不把未经确认的规格写成事实。

##### 本地化提示词

```
制作一段 30 秒、16:9 的电影感环境揭示。蓝调时刻从安静室内开始，一位人物打开高窗。用缓慢手持推进跟随动作，然后走向开阔的海岸风景：云层、远处灯光和近处布料上可见的风都保持自然。世界展开时，人物和建筑保持一致。声音从室内环境过渡到风、鸟、海浪和克制的管弦乐上扬。让最后的大全景停留数秒。优先保证空间连续性、物理光线和清晰的镜头路径。不要文字、字幕、标志或虚构技术标签。
```
...
<div align="center">
<a href="https://video.twimg.com/amplify_video/2084741113894584320/vid/avc1/1280x720/VKBqU5of84zaTd6F.mp4?tag=29"><img src="https://pbs.twimg.com/amplify_video_thumb/2084741113894584320/img/vqjwcPxwyqxvccJB.jpg" height="420" alt="官方演示风格的环境揭示与原生声音 - Motion preview"></a>

*点击预览图打开视频* · **[▶ 观看视频 →](https://video.twimg.com/amplify_video/2084741113894584320/vid/avc1/1280x720/VKBqU5of84zaTd6F.mp4?tag=29)**
</div>

##### 证据

- **创作者:** [Furkan Gozukara](https://x.com/FurkanGozukara)
- **规范来源:** [规范来源](https://x.com/FurkanGozukara/status/2084741391012286807)
- **发布时间:** 2026年8月4日
- **提示词语言:** en
...
- [固定屏幕方向的七镜头长枪决斗](#prompt-2)

## 贡献已核验案例

找到能教会真实导演模式的 Wan 3.0 Video 案例？通过 GitHub Issues 提交提示词、可播放结果、创作者、来源、模型证据和输入模式。

### GitHub issue

1. [**提交视频提示词**](https://github.com/imagineVid/Awesome-wan-3-0-prompts-and-skills/issues/new?template=submit-prompt.yml)
...
**[仓库增长](https://star-history.com/#imagineVid/Awesome-wan-3-0-prompts-and-skills&Date)**

---

<div align="center">

**[使用 Wan 3.0 Video 创作](https://imaginevid.io/zh/text-to-video)** •
...
<sub>根据版本化本地数据生成于 2026-08-20T01:00:54.212Z</sub>
